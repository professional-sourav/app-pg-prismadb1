export default function TaskPopup({ id, children }: { id: string; children: React.ReactNode }) {
  return (
    <div id={id} className="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabIndex="-1" aria-labelledby={id}>
